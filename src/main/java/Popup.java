...
class Popup extends JPopupMenu
{
    ...
    public Popup()
    {
        ...
        jmenuItem_cut.setFont(new Font("Arial", Font.PLAIN, 14));
        jmenuItem_copy.setFont(new Font("Arial", Font.PLAIN, 14));
        jmenuItem_paste.setFont(new Font("Arial", Font.PLAIN, 14));
        jmenuItem_delete.setFont(new Font("Arial", Font.PLAIN, 14));
        jmenuItem_selectAll.setFont(new Font("Arial", Font.PLAIN, 14));
        jmenuItem_undo.setFont(new Font("Arial", Font.PLAIN, 14));
    }
